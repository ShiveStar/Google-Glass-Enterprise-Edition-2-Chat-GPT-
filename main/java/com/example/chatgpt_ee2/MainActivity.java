    ...
    private class SendQuestionTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... questions) {
            ...
            try {
                ...
                String requestBody = "{\"messages\":[{\"role\":\"system\",\"content\":\"You are a concise assistant. Your responses are short but informative, no more than 188 characters including spaces and punctuation\"},{\"role\":\"user\",\"content\":\"" + question + "\"}],\"max_tokens\":80, \"model\": \""+model+"\"}";
